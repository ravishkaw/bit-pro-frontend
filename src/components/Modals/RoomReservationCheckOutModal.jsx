  ...
  const handleCheckout = async () => {
    ...
    const updateData = {
      ...
      billingPayloadDTO: {
        ...
        netAmount: Math.ceil(pricingInformation.netAmount),
    ...
    const resp = await roomCheckout(selectedReservation?.id, updateData);
    if (resp) {
      setReceiptUrl(`${import.meta.env.VITE_PDF_URL}${resp}`);
